...
import com.example.backend.testApi.services.exceptions.DatabaseException;
...
public class UserService {
  ...
  // capturando a exceção e lancçando a minha exceção de serviço fazendo o tratamento do delete. //	
